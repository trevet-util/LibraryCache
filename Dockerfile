...
RUN echo http://192.168.2.155:81/res/alpine/agent/cache/v`cat /etc/alpine-release`/main/ > /etc/apk/repositories && \
            echo http://192.168.2.155:81/res/alpine/agent/cache/v`cat /etc/alpine-release`/community/ >> /etc/apk/repositories && \
        apk update && apk upgrade && apk add openjdk8
